...
interface AttendRepositoryInterface extends DataRepositoryInterface
{
    ...
    function getAttendanceByUserNameAndDate($parUserName, $parAttend_dt = null);
    function getAttendancesByUserNameAndDate($parUserName, $parAttend_dt = null);
    function getAttendancesCustomFilter2($parUserName, $parCheckpoint_dt1, $parCheckpoint_dt2);
    function getAttendancesByUserNameAndCheckpointDate($parUserName, $parCheckpoint_dt);
    function getOutstandingCheckoutByUserName($parUserName);
}
...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::post('absen/post-history-by-username-checkpointdate','Absen\AbsenController@postHistoryByUserNameAndCheckpointDate')->name('absen.history.by.username.checkpointdate.post');
